...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const CONFIG = {
    ...
    superKeywords: {
      "Cognitive Processes & Learning Mechanisms": [
        "AI Use",
        "Cognitive Appraisal",
        "Expectancy Effects",
        "Implicit Learning",
      ...
      "Education, Development & Learning Contexts": [
        "Children",
        "Young People",
        "SEND Systems",
      ...
      "Mental Health, Wellbeing & Health Psychology": [
        "Anxiety",
        "Depression",
        "Stress",
        "Stress Appraisal",
      ...
      "Social Processes & Behaviour Change": [
        "Connectedness",
        "Social Cognition",
